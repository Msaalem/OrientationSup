...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 05 juin 2022 à 06:13
...
--
-- Déchargement des données de la table `capfiliere`
--
...
CREATE TABLE `choix` (
  ...
  `c3` varchar(60) DEFAULT NULL,
  `c4` varchar(60) DEFAULT NULL,
  `c5` varchar(60) DEFAULT NULL,
  `c6` varchar(60) DEFAULT NULL,
  `c7` varchar(60) DEFAULT NULL,
  `c8` varchar(60) DEFAULT NULL
...
INSERT INTO `choix` (`matricule`, `c1`, `c2`, `c3`, `c4`, `c5`, `c6`, `c7`, `c8`) VALUES
('R', 'T', 'k', 'p', 'l', '[value-6]', 'm', 'v', 'f'),
('900', 'a', '[value-3]', 'b', 'c', 'd', 'e', 'f', 'g'),
('21012', 'Institut Superieur des Metiers de la Mine (IS2M)- ZTE', 'Institut Superieur des Metiers du Numerique', '[value-4]', '[value-5]', '[value-6]', '[value-7]', '[value-8]', '[value-9]'),
('[value-1]', '[value-2]', '[value-3]', '[value-4]', '[value-5]', '[value-6]', '[value-7]', '[value-8]', '[value-9]'),
('21013', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `choix_c`
--

CREATE TABLE `choix_c` (
  `matricule` int(11) DEFAULT NULL,
  `c1` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
  `c2` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
  `c3` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
  `c4` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
  `c5` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
  `c6` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
  `c7` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
  `c8` varchar(10) CHARACTER SET latin1 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `filiere_c` (
  `FILIERE` varchar(90) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `filiere_c`
--

INSERT INTO `filiere_c` (`FILIERE`) VALUES
('CPGE (Classes Preparatoires aux Grandes Ecoles) '),
('FM: Medecine UNA'),
('Institut Superieur de la Science de la Mer (ISSM) - NDB'),
('Institut Superieur des Metiers de la Statistique(ISMS)	'),
('Institut Superieur des Metiers de l\'Energie'),
('Institut Superieur des Metiers du Batiment des Travaux Publics et et d\'Urbanisme d\'Aleg)'),
('Institut Superieur des Metiers du Numerique'),
('Institut Superieur des Metiers de la Mine (IS2M)- ZTE');
...
--
-- Déchargement des données de la table `filiere_d`
--

INSERT INTO `filiere_d` (`id`, `Nom`, `Code`, `Capacite`) VALUES
(4, 'Ingenieure agromome', '', 12),
(3, 'Ingenieure en Mecanique', '', 24),
(2, 'Ingenieure en Industrie', '', 0),
(1, 'Ecole Nationale des Sciences appliquees', 'ENSA', 0),
(5, 'Sciences appliquees et de technologie(MAROC)', '', 0),
(6, 'Sciences appliquees et de technologie(ALGERIE)', '', 0),
(7, 'Medcine UNA', 'FM', 0),
(8, 'Medcine Generale (age max.21 ans \"MAROC\")', 'FM', 0),
(9, 'Medcine Generale (age entre 18 et 20 ans \"SENEGAL\")', 'FM', 0),
(10, 'Medcine Generale \"TUNISIE\"', 'FM', 0),
(11, 'Medcine Dentaire (age entre 18 et 20 ans \"SENEGAL\")', 'FM', 0),
(12, ' Pharmacie (age entre 18 et 22 ans \"SENEGAL\")', 'FM', 0),
(13, 'Pharmacie (\"TUNISIE\")', 'FM', 0),
(14, 'Medecine veterinaire HassanII ( age max.23 ans \"MAROC\")', 'FM', 0),
(15, 'Biotechnologie (\"TUNISIE\")', '', 0),
(16, 'Sciences de l\'agriculture (\"MAROC\")', '', 0),
(18, 'Sciences de l\'agriculture (\"TUNISIE\")', '', 0),
(28, 'Docteur en Medecine', '', 0),
(34, 'Institut Superieur des Metiers du Numerique', '', 0),
(35, 'Institut Superieur des Metiers de la Mine (IS2M)- ZTE', '', 0);
...
--
-- Déchargement des données de la table `formul_note`
--
...
INSERT INTO `note` (`et`, `mt`, `note`) VALUES
(21001, 'ANG', 8),
(21001, 'AR', 15),
(21001, 'FR', 8),
(21001, 'IR', 12),
...
--
-- Structure de la table `note_min`
--

CREATE TABLE `note_min` (
  `filiere` varchar(100) NOT NULL,
  `matiere` varchar(20) NOT NULL,
  `note_minimal` int(11) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `note_min`
--

INSERT INTO `note_min` (`filiere`, `matiere`, `note_minimal`) VALUES
('CPGE', 'Math', 0),
('Medecine UNA', 'Math', 0),
('Medecine UNA', 'PC', 0),
('Medecine UNA', 'SN', 0),
...
--
-- Déchargement des données de la table `orientations2021`
--
...
CREATE TABLE `resultat` (
  ...
  `oriantation` varchar(60) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `resultat` (`matricule`, `oriantation`) VALUES
('21011', 'sup'),
('21012', 'med');
...
--
ALTER TABLE `note`
  ADD PRIMARY KEY (`et`,`mt`);

--
-- Index pour la table `note_min`
--
ALTER TABLE `note_min`
  ADD PRIMARY KEY (`filiere`,`matiere`);
...
--
ALTER TABLE `note`
  MODIFY `et` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21004;
COMMIT;
